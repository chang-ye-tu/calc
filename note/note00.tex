...
\begin{ex}
  \begin{itemize}\setlength\itemsep{0em}
    ...
    \item 證明函數 $f:\mathbb{R}_+\to\mathbb{R}$, $\mathbb{R}_+ = \{x\,|\,x\geqslant 0\}$, $f(x) = x^2$ 為嵌射.
  \end{itemize}
\end{ex}
...
\begin{sol}
  $\forall\,x_1, x_2\in\mathbb{R}$, $\ds f(x_1) = f(x_2) \ie x_1^3 = x_2^3 \ie (x_1 - x_2)(x_1^2 + x_1 x_2 + x_2^2) = 0 \ie x_1 - x_2 = 0\,\vee\, x_1^2 + x_1 x_2 + x_2^2 = 0 \ie x_1 = x_2\,\vee\,\Big(x_1 + \frac{x_2}{2}\Big)^2 + \frac{3x_2^2}{4} = 0 \ie x_1 = x_2\,\vee\, x_2 = x_1 = 0 \ie x_1 = x_2$.  
\end{sol}
