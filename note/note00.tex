    ...
    \item 廣義角三角函數
      \begin{figure}[!htbp]
        ...
        \begin{tikzpicture}[scale=1.5,>={Stealth[scale=1]}]
          ...
          \draw (3 / 2, 0) coordinate (a) -- (0, 0) coordinate (b) -- (-1.06, 1.06) coordinate (c) pic ["$\alpha$", draw,->,blue,angle radius=9mm] {angle = a--b--c};
          \draw (-1.06, 1.06) coordinate (a) -- (0, 0) coordinate (b) -- (3 / 2, 0) coordinate (c) pic ["$\alpha - 2\pi$", draw,<-,red,angle radius=11mm] {angle = a--b--c};
