...
\begin{prp}
  ...
  \begin{multicols}{2}
    \begin{enumerate}\setlength\itemsep{0em}
      \item $f'(x) > 0$ $\ie$ $f$ 在 $[a, b]$ 嚴格遞增. 
      \item $f'(x) < 0$ $\ie$ $f$ 在 $[a, b]$ 嚴格遞減. 
      \item $f'(x) \geqslant 0$ $\ie$ $f$ 在 $[a, b]$ 遞增. 
      \item $f'(x) \leqslant 0$ $\ie$ $f$ 在 $[a, b]$ 遞減. 
    \end{enumerate}
  \end{multicols}
\end{prp}
...
%\begin{ex}
%  證明 $\tan^{-1}x + \frac{x}{\sqrt{1 + x^2}} = 1$ 僅有唯一解. 
%\end{ex}
%
%\begin{sol}
%  令 $f(x) = \tan^{-1}x + \frac{x}{\sqrt{1 + x^2}} - 1$, 則 $\forall\,x\;(f'(x) = \frac{1}{1 + x^2} + \frac{1}{(1 + x^2)^{\frac{3}{2}}} > 0)$, $f(0) = -1 < 0$, $f(1) = \frac{\pi}{4} - \frac{1}{2} > 0$, 故由 Bolzano 定理, 存在 $\ds c\in(0, 1)$ 使 $f(c) = 0$. 若存在另一 $c_0\ne c$ 使 $f(c_0) = 0$, 則由 Rolle 定理, 存在 $c_1$ 介於 $c$, $c_0$ 間使 $f'(c_1) = 0$, 與 $\forall\,x\;(f'(x) = \frac{1}{1 + x^2} + \frac{1}{(1 + x^2)^{\frac{3}{2}}} > 0)$ 矛盾; 得證. 
%\end{sol}
%
%\begin{ex}
%  證明 $x + \tan^{-1}x + \frac{1}{1 + x^2} = 2$ 僅有唯一解. 
%\end{ex}
%
%\begin{sol}
%  令 $f(x) = x + \tan^{-1}x + \frac{1}{1 + x^2} - 2$, 則 $\forall\,x\;(f'(x) = 1 + \frac{1}{1 + x^2} - \frac{2x}{(1 + x^2)^2} = 1 + \frac{(x - 1)^2}{(1 + x^2)^2}\geqslant 1 > 0)$, $f(0) = -1 < 0$, $f(1) = \frac{\pi}{4} - \frac{1}{2} > 0$, 故由 Bolzano 定理, 存在 $\ds c\in(0, 1)$ 使 $f(c) = 0$. 若存在另一 $c_0\ne c$ 使 $f(c_0) = 0$, 則由 Rolle 定理, 存在 $c_1$ 介於 $c$, $c_0$ 間使 $f'(c_1) = 0$, 與 $\forall\,x\;(f'(x) = 1 + \frac{(x - 1)^2}{(1 + x^2)^2} > 0)$ 矛盾; 得證.
%\end{sol}
