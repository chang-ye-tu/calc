...
\begin{align*}
  \lim_{x\to 2}\frac{x - 2}{x^2 + x - 6} = \frac{1}{5}\;(= 0.2)
\end{align*}
...
\begin{sol}
  若 $x\ne 0$, $\ds 0\leqslant\sin^2\Big(\frac{1}{x}\Big)\leqslant 1$, 則 $\ds-|x|\leqslant x\sin^2\Big(\frac{1}{x}\Big)\leqslant|x|$. 又 $\ds\lim_{x\to 0}(-|x|) = \lim_{x\to 0}|x| = 0$, 由夾擠定理 $\ds\lim_{x\to 0}x\sin^2\Big(\frac{1}{x}\Big) = 0$. 
\end{sol}
...
\begin{rmk}
  \begin{itemize}\setlength\itemsep{0em}
    ...
    \item $\ds f(x) = \begin{cases}x\sin\Big(\frac{1}{x}\Big)& x \ne 0 \\ 0 & x = 0\end{cases}$, 則存在無限多 $\ds x\in\Big[-\frac{2}{3\pi},\,\frac{2}{\pi}\Big]$ 使 $f(x) = 0$. 
  \end{itemize}
\end{rmk}
