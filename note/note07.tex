...
\begin{sol}
  \begin{multicols}{2}
    \begin{enumerate}\setlength{\itemsep}{0pt}
      \item $\ds\int_2^3\!\int_1^5\!(x + 2y)\,\text{d}x\,\text{d}y = 32$
      \item $\ds\int_{-\pi}^{\pi}\!\int_0^2 r\sin\theta\,\text{d}r\,\text{d}\theta = 0$
      \item $\ds\int_0^{\ln 4}\!\!\int_0^{\ln 3}\!\!e^{x + y}\,\text{d}x\,\text{d}y = 6$
      \item $\ds\int_0^{\frac{\pi}{2}}\!\int_0^{\cos y}\!e^x\sin y\,\text{d}x\,\text{d}y = e - 2$
      \item $\ds\int_0^{\frac{\pi}{2}}\!\int_0^{\cos\theta}\!\!\rho^2\sin\theta\,\text{d}\rho\,\text{d}\theta = \frac{1}{12}$
      \item $\ds\int_0^1\!\int_{x^2}^{x^3}\!(x^2 + y^2)\,\text{d}y\,\text{d}x = -\frac{1}{21}$
      \item $\ds\int_1^2\!\int_0^y\!x\sqrt{y^2 - x^2}\,\text{d}x\,\text{d}y = \frac{5}{4}$
      \item $\ds\int_0^1\!\int_{y^4}^{y^2}\!\!\sqrt{\frac{y}{x}}\,\text{d}x\,\text{d}y = \frac{8}{35}$
      \item $\ds\int_0^1\!\int_0^z\int_0^y\!(x + y + z)\,\text{d}x\,\text{d}y\,\text{d}z = \frac{1}{4}$
    \end{enumerate}
  \end{multicols}
\end{sol}
...
\begin{sol}
  由 $\ds\int_0^\infty\!e^{-xy}\,\text{d}y = \frac{1}{x}$，$x > 0$; 又 $\ds\int\!e^{ax}\sin bx\,\text{d}x = \frac{e^{ax}(a\cdot\sin bx - b\cdot\cos bx)}{a^2 + b^2}$. \\故 $\ds\int_0^\infty\!\frac{\sin x}{x}\,\text{d}x = \int_0^\infty\!\bigg(\sin x\int_0^\infty\!e^{-xy}\,\text{d}y\bigg)\,\text{d}x = \int_0^\infty\!\bigg(\int_0^\infty\!e^{-xy}\sin x\,\text{d}y\bigg)\,\text{d}x = \int_0^\infty\!\bigg(\int_0^\infty\!e^{-xy}\sin x\,\text{d}x\bigg)\,\text{d}y = \int_0^\infty\!\frac{e^{-xy}((-y)\cdot\sin x - 1\cdot\cos x)}{(-y)^2 + 1^2}\,\Big|_{x = 0}^{x = \infty}\,\text{d}y = \int_0^\infty\!\frac{0 - (-1)}{1 + y^2}\,\text{d}y = \int_0^\infty\!\frac{1}{1 + y^2}\,\text{d}y = \tan^{-1}y\,\Big|_{0}^{\infty} = \frac{\pi}{2}$. 
\end{sol}
