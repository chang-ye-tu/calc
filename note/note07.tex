...
\begin{exe}
  ...
  \begin{multicols}{3}
    \begin{enumerate}\setlength{\itemsep}{0pt}
      ...
      \item $\ds\int_0^1\!\int_0^1\frac{xy}{\sqrt{x^2 + y^2 + 1}}\,\text{d}y\,\text{d}x$
...
\begin{sol}
  \begin{enumerate}\setlength{\itemsep}{0pt}
    ...
    \item $\ds\int_0^1\!\int_0^1\frac{xy}{\sqrt{x^2 + y^2 + 1}}\,\text{d}y\,\text{d}x = \int_0^1\!x\bigg(\int_0^1\frac{y}{\underbrace{\sqrt{x^2 + y^2 + 1}}_{\text{令 }\;u = y^2 + x^2 + 1,\;\mathrm{d}u = 2y\mathrm{d}y}}\,\text{d}y\bigg)\text{d}x = \int_0^1\!x\bigg(\frac{1}{2}\int_{x^2 + 1}^{x^2 + 2}\frac{1}{\sqrt{u}}\,\text{d}u\bigg)\text{d}x \\= \int_0^1 x(\sqrt{x^2 + 2} - \sqrt{x^2 + 1})\,\mathrm{d}x = \int_0^1 x\underbrace{\sqrt{x^2 + 2}}_{\text{令}u = x^2 + 2}\,\mathrm{d}x - \int_0^1x\underbrace{\sqrt{x^2 + 1}}_{\text{令}\;u = x^2 + 1}\,\mathrm{d}x = \sqrt{3} - \frac{4}{3}\sqrt{2} + \frac{1}{3}$
