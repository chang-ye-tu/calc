...
\begin{sol}
  \begin{enumerate}\setlength{\itemsep}{0pt}
   ...
   % \item $\ds\int_0^1\!\int_0^z\!\int_0^y\!(x + y + z)\,\text{d}x\,\text{d}y\,\text{d}z = \int_0^1\!\int_0^z\!\bigg(\int_0^y\!(x + y + z)\,\text{d}x\bigg)\,\text{d}y\,\text{d}z = \int_0^1\!\int_0^z\!\bigg(\frac{x^2}{2} + (y + z)x\bigg)\,\bigg|_{x = 0}^{x = y}\,\text{d}y\,\text{d}z \\ = \int_0^1\!\int_0^z\!\bigg(\frac{3y^2}{2} + zy\bigg)\,\text{d}y\,\text{d}z = \int_0^1\!\bigg(\frac{y^3}{2} + \frac{zy^2}{2}\bigg)\,\bigg|_{y = 0}^{y = z}\,\text{d}z = \int_0^1\!z^3\,\text{d}z = \frac{1}{4}$
  \end{enumerate}
\end{sol}
...
\begin{ex}
  求 $\ds\int_0^\infty\!e^{-x^2}\,\text{d}x$. 
\end{ex}

\begin{sol}
  $\ds\bigg(\int_0^\infty\!e^{-x^2}\,\text{d}x\bigg)^2 = \bigg(\int_0^\infty\!e^{-x^2}\,\text{d}x\bigg)\bigg(\int_0^\infty\!e^{-y^2}\,\text{d}y\bigg) = \int_0^\infty\!\!\!\int_0^\infty\!\!e^{-x^2 - y^2}\,\text{d}x\,\text{d}y$. 極座標變數變換得 \\$\ds\int_0^\infty\!\!\!\int_0^\infty\!\!e^{-x^2 - y^2}\,\text{d}x\,\text{d}y = \lim_{R\to\infty}\int_0^{\frac{\pi}{2}}\!\!\!\int_0^R\!\!e^{-r^2}r\,\text{d}r\,\text{d}\theta = \frac{\pi}{2}\lim_{R\to\infty}\!\!\bigg(\frac{-e^{-r^2}}{2}\,\bigg|_0^R\bigg) = \frac{\pi}{4}$, 故$\ds\int_0^\infty\!e^{-x^2}\,\text{d}x = \frac{\sqrt{\pi}}{2}$.
\end{sol}
