...
\begin{ex}
  若 $\ds\int_E f(x, y, z)\,\text{d}V = \int_0^1\!\int_{\sqrt{x}}^{1}\int_0^{1 - y}\!\!f(x, y, z)\,\text{d}z\,\text{d}y\,\text{d}x$, 寫出其他五個等價但積分順序不同之積分式.
\end{ex}
...
\begin{ex}
  若 $\ds\int_E f(x, y, z)\,\text{d}V = \int_{-1}^1\!\int_0^{1 - y^2}\!\!\int_0^{2 - y - z}\!\!f(x, y, z)\,\text{d}x\,\text{d}z\,\text{d}y$, 寫出等價依積分順序 $z\to x\to y$ 之積分式.
\end{ex}
...
\begin{ex}
  若 $\ds\int_E f(x, y, z)\,\text{d}V = \int_0^1\!\int_0^{1 - \frac{x}{2}}\!\!\int_{0}^{4 - 2x - 4z}\!\!f(x, y, z)\,\text{d}y\,\text{d}z\,\text{d}x$, 寫出等價依積分順序 $z\to x\to y$ 之積分式.
\end{ex}
...
\begin{ex}
  若 $E$ 為 $z = 1 - x^2$, $y = z$, $y = 0$, $z = 0$ 圍成之區域, 寫出 $\ds\int_E f(x, y, z)\,\text{d}V$ 之積分式.
\end{ex}

\begin{sol}
  \begin{minipage}{0.69\textwidth}
    \includegraphics[scale=0.7,page=20]{fig/prob.pdf}\vspace{-3mm} 
    \includegraphics[scale=0.7,page=21]{fig/prob.pdf}\vspace{-3mm}
    \includegraphics[scale=0.7,page=22]{fig/prob.pdf} 
  \end{minipage}
  \begin{minipage}{0.31\textwidth}
    \begin{align*}
      &\qquad\int_E f(x, y, z)\,\text{d}V \\
      &= \int_{-1}^1\!\int_0^{1 - x^2}\!\!\!\!\!\int_{y}^{1 - x^2}\!\!\!\!\!\!f(x, y, z)\,\text{d}z\,\text{d}y\,\text{d}x
    \end{align*}
  \end{minipage}
\end{sol}
...
\begin{sol}
  \begin{minipage}{0.55\textwidth}
    \includegraphics[scale=0.72,page=23]{fig/prob.pdf} 
    \includegraphics[scale=0.72,page=24]{fig/prob.pdf} 
    \includegraphics[scale=0.72,page=25]{fig/prob.pdf} \\
    \includegraphics[scale=0.78,page=26]{fig/prob.pdf} 
    \includegraphics[scale=0.55,page=27]{fig/prob.pdf} 
    \includegraphics[scale=0.6,page=28]{fig/prob.pdf} 
  \end{minipage}
  \begin{minipage}{0.45\textwidth}
    \begin{align*}
      &\quad\;\int_E\!\!f(x, y, z)\,\text{d}V \\
...
\begin{sol}
  \begin{minipage}{0.55\textwidth}
    \includegraphics[scale=0.6,page=30]{fig/prob.pdf} 
    \includegraphics[scale=0.6,page=32]{fig/prob.pdf} \\
    \includegraphics[scale=0.5,page=31]{fig/prob.pdf} 
    \includegraphics[scale=0.6,page=33]{fig/prob.pdf} 
  \end{minipage}
  \quad
  \begin{minipage}{0.45\textwidth}
    \begin{align*}
