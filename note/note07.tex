...
\begin{sol}
  ...
  \begin{minipage}{0.7\textwidth}
    ...
    %\end{align*}
    \begin{itemize}
      \item 柱面座標: $\ds\text{體積} = 8\cdot\int_0^{\frac{\pi}{2}}\!\!\int_b^a\!\int_0^{\sqrt{a^2 - r^2}}\!r\,\text{d}z\,\text{d}r\,\text{d}\theta = \frac{4\pi}{3}(a^2 - b^2)^{\frac{3}{2}}$ 
      \item 球面座標: $\ds\text{體積} = 2\int_{\sin^{-1}\frac{b}{a}}^{\frac{\pi}{2}}\!\!\!\int_0^{2\pi}\!\!\!\int_{\frac{b}{\sin\varphi}}^{a}\rho^2\sin\varphi\,\text{d}\rho\,\text{d}\theta\,\text{d}\varphi = \frac{4\pi}{3}(a^2 - b^2)^{\frac{3}{2}}$
    \end{itemize}
  \end{minipage}
\end{sol}
