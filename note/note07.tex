...
\begin{sol}
  ...
  \begin{minipage}{0.8\textwidth}
    \begin{align*}
      \text{(表面積)} &= 16\int_0^a\!\!\int_0^x\!\!\sqrt{1 + \Big(\frac{-x}{\sqrt{a^2 - x^2}}\Big)^2}\,\text{d}y\,\text{d}x = 16\int_0^a\!\!\int_0^x\!\!\sqrt{\frac{a^2}{a^2 - x^2}}\,\text{d}y\,\text{d}x \\ &= 16 a\int_0^a\!\!\frac{x}{\sqrt{a^2 - x^2}}\,\text{d}x = 16 a^2. \\
