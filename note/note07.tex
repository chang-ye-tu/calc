...
\begin{ex}
  若 $E$ 為第一卦限中由 $y = x^2$, $y + z = 1$ 圍成之區域, 求 $\ds\int_E x\,\text{d}V$.
\end{ex}
...
\begin{ex}
  若 $E$ 為第一卦限中由 $z = y^2$, $x + y = 1$ 圍成之區域, 求 $\ds\int_E z\,\text{d}V$.
\end{ex}
...
\begin{ex}
  若 $E$ 為 $z = 1 - x^2$, $y = z$, $y = 0$, $z = 0$ 圍成之區域, 寫出 $\ds\int_E \text{d}V$ 之積分式.
\end{ex}
...
\begin{ex}
  若 $E$ 為由 $x = 1$, $y = 1$, $z = 1$, $x + y + z = 2$ 圍成之四面體, 求 $\ds\int_E x\,\text{d}V$.
\end{ex}
...
\begin{ex}
  若 $E$ 為第一卦限中由 $y^2 + z^2 = 1$, $x + y = 2$, $y = 0$, $z = 0$ 圍成之區域, 求 $\ds\int_E z\,\text{d}V$.
\end{ex}
...
\begin{ex}
  若 $E$ 為由 $x = 0$, $y = 0$, $z = 0$, $x + y + z = 2$, $x^2 + z = 1$ 圍成之區域, 求 $\ds\int_E x\,\text{d}V$.
\end{ex}
...
\begin{sol}
  $\ds\int_0^1\!\!\int_y^{1}\!\!\int_0^{y}\!\!\,\text{d}z\,\text{d}x\,\text{d}y = \int_0^1\!\!\int_0^{x}\!\!\int_0^{y}\!\!\,\text{d}z\,\text{d}y\,\text{d}x = \int_0^1\!\!\int_z^1\!\!\int_{y}^1\!\!\,\text{d}x\,\text{d}y\,\text{d}z = \int_0^1\!\!\int_0^y\!\!\int_{y}^1\!\!\,\text{d}x\,\text{d}z\,\text{d}y = \int_0^1\!\!\int_0^{x}\!\!\int_z^{x}\!\!\,\text{d}y\,\text{d}z\,\text{d}x \\= \int_0^1\!\!\int_{z}^1\!\!\int_z^{x}\!\!\,\text{d}y\,\text{d}x\,\text{d}z$.
\end{sol}
...
\begin{sol}
  ...
  \begin{minipage}{0.78\textwidth}
    \begin{enumerate}
      \item 柱面座標: $\ds\int_E z\sqrt{x^2 + y^2 + z^2}\,\text{d}V = \int_0^{2\pi}\!\!\!\int_0^1\!\!\!\int_{0}^{r}\!z\sqrt{r^2 + z^2}\cdot r\,\text{d}z\,\text{d}r\,\text{d}\theta = 2\pi\,\int_0^1\!\frac{r}{3}(r^2 + z^2)^{\frac{3}{2}}\,\Big|_{z = 0}^{z = r}\,\text{d}r = \frac{2\pi}{3}\int_0^1 r\cdot(2^{\frac{3}{2}} - 1)\,r^3\,\text{d}r = \frac{2\pi\,(2^{\frac{3}{2}} - 1)}{15}$ 
...
\begin{sol}
  ...
  \begin{minipage}{0.78\textwidth}
    \begin{enumerate}
      \item 柱面座標: $\ds\int_E z\,(x^2 + y^2 + z^2)\,\text{d}V = \int_0^{2\pi}\!\!\!\int_0^1\!\!\int_{r^2}^{r}\!z\,(r^2 + z^2)\cdot r\,\text{d}z\,\text{d}r\,\text{d}\theta = 2\pi\int_0^1\!\!\int_{r^2}^{r}(r^3z + rz^3)\,\text{d}z\,\text{d}r = 2\pi\int_0^1\Big(\frac{r^3}{2}(r^2 - r^4) + \frac{r}{4}(r^4 - r^8)\Big)\,\text{d}r = \frac{3\pi}{40}$ 
      \item 球面座標: $z = x^2 + y^2 \ie \rho\cos\varphi = \rho^2\sin^2\varphi \ie \rho = \frac{\cos\varphi}{\sin^2\varphi}$; \\$z = \sqrt{x^2 + y^2} \ie \rho\cos\varphi = \rho\sin\varphi \ie \tan\varphi = 1$; \\$\ds\int_E z\,(x^2 + y^2 + z^2)\,\text{d}V = \int_{\frac{\pi}{4}}^{\frac{\pi}{2}}\!\!\!\int_0^{2\pi}\!\!\!\int_0^{\frac{\cos\varphi}{\sin^2\varphi}}\!\!\rho\cos\varphi\cdot\rho^2\cdot\rho^2\sin\varphi\,\text{d}\rho\,\text{d}\theta\,\text{d}\varphi$
    \end{enumerate}
  \end{minipage}
\end{sol}
