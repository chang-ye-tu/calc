...
\begin{prf}
  ...
  \begin{minipage}{0.48\textwidth}
    $\ds\text{比較面積:}\;\Delta OPR \leqslant \text{扇形}\;OPR \leqslant \Delta OQR \\ \ie\sin h\leqslant h \leqslant\frac{\sin h}{\cos h} \ie\cos h\leqslant\frac{\sin h}{h}\leqslant 1$. \\ 由 $\ds\lim_{h\to 0+}\cos h = 1$ 與夾擊定理, $\ds\lim_{h\to 0+}\frac{\sin h}{h} = 1$. \\ 又 $\ds\lim_{h\to 0-}\frac{\sin h}{h} = \lim_{-h\to 0+}\frac{\sin h}{h} = \lim_{-h\to 0+}\frac{\sin(-h)}{(-h)} \\ = \underbrace{\lim_{H\to 0+}\frac{\sin H}{H}}_{\text{令 $H = -h$}} = 1$, 故 $\ds\lim_{h\to 0}\frac{\sin h}{h} = 1$.
  \end{minipage}
\end{prf}
