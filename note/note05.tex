...
\begin{rmk}
  \begin{itemize}
    \item 正定 $3\times 3$ 矩陣範例：$\ds\vM = \begin{pmatrix}2 & -1 & 0\\-1 & 2 & -1\\ 0 & -1 & 2\end{pmatrix}$。若 $\ds\vv = \llt a,\,b,\,c\rgt$，$a,\,b,\,c\in\mathbb{R}$，則 $\ds\vv\vM\vv^\top = \begin{pmatrix}a & b & c\end{pmatrix}\begin{pmatrix}2 & -1 & 0\\-1 & 2 & -1\\ 0 & -1 & 2\end{pmatrix}\begin{pmatrix}a\\b\\c\end{pmatrix} = \begin{pmatrix}2a - b&-a + 2b - c&-b + 2c\end{pmatrix}\begin{pmatrix}a\\b\\c\end{pmatrix} = (2a - b)a + (-a + 2b - c)b + (-b + 2c)c = 2a^2-2ab+2b^2 - 2bc + 2c^2 = a^2 + (a - b)^2 + (b - c)^2 + c^2 > 0$，除 $a = b = c = 0$ 外。
    \item 正定矩陣判定準則 (Sylvester)：$\vM$ 為正定 $\ifff$ $\vM$ 所有 principal minor 之行列式值均為正。
    \item 矩陣 $\ds\begin{pmatrix}2 & -1 & 0\\-1 & 2 & -1\\ 0 & -1 & 2\end{pmatrix}$ 之所有 principal minors 依次為 $\ds2,\;\begin{pmatrix}2 & -1 \\ -1 & 2\end{pmatrix},\;\begin{pmatrix}2 & -1 & 0\\-1 & 2 & -1\\ 0 & -1 & 2\end{pmatrix}$，行列式值分別為 $2,\,3,\,4$，故為正定。
  \end{itemize}
\end{rmk}
