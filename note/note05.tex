...
\begin{dfn}
  給定 $\ds R\subseteq\mathbb{R}^n$，$\ds f:R\to\mathbb{R}$，$\ds B(\vx, h)\equiv\{\vy\in\mathbb{R}^n\;|\;|\vy - \vx| < h\}$。
  \begin{itemize}\setlength\itemsep{0em}
    \item $f$ 在 $\ds\vx_\text{M}\in R$ 有最大值 (global maximum) $\ds f(\vx_\text{M})$：$\ds f(\vx_\text{M})\geqslant f(\vx),\;\forall\,\vx\in R$。
    \item $f$ 在 $\ds \vx_\text{m}\in R$ 有最小值 (global minimum) $\ds f(\vx_\text{m})$：$\ds f(\vx_\text{m})\leqslant f(\vx),\;\forall\,\vx\in R$。
    \item $f$ 在 $\ds\vx_0\in R$ 有極大值 (local maximum) $\ds f(\vx_0)$：$\ds\exists\,h_0 > 0$ 使 $\ds f(\vx_0)\geqslant f(\vx),\;\forall\,\vx\in B(\vx_0, h_0)\,\cap\,R$。
    \item $f$ 在 $\ds\vx_1\in R$ 有極小值 (local minimum) $\ds f(\vx_1)$：$\ds\exists\,h_1 > 0$ 使 $\ds f(\vx_1)\leqslant f(\vx),\;\forall\,\vx\in B(\vx_1, h_1)\,\cap\,R$。
  \end{itemize}
\end{dfn}
