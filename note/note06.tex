...
\begin{sol}
  \begin{enumerate}\setlength\itemsep{0em}
    ...
    \item $\ds \lim_{x\to\infty}\Big(1 + \frac{a}{x}\Big)^x = \lim_{x\to\infty}e^{x\ln(1 + \frac{a}{x})} = e^{\lim_{x\to\infty}x\ln(1 + \frac{a}{x})} = e^{\lim_{x\to\infty}\frac{\ln(1 + \frac{a}{x})}{\frac{1}{x}}} = e^{\lim_{x\to\infty}\frac{\frac{-\frac{a}{x^2}}{1 + \frac{a}{x}}}{-\frac{1}{x^2}}} = e^a$
    ...
    \item $\ds\lim_{x\to\infty} a^{\frac{1}{x}} = \lim_{x\to\infty}e^{\frac{1}{x}\ln a} = e^0 = 1$
    \item $\ds \lim_{x\to\infty} x^{\frac{1}{x}} = \lim_{x\to\infty}e^{\frac{1}{x}\ln x} = e^{\lim_{x\to\infty}\frac{\ln x}{x}} = e^0 = 1$
    \item $\ds \lim_{x\to\infty} x^{\frac{2}{x}} = \lim_{x\to\infty}e^{\frac{2}{x}\ln x} = e^{2\lim_{x\to\infty}\frac{\ln x}{x}} = e^0 = 1$
