...
\begin{exe} 求下列不定積分. 
  ...
  \begin{multicols}{2}
    \begin{enumerate}\setlength{\itemsep}{0pt}
      ...
      \item $\ds\int\!\sec^2 x - \sec x\tan x\,\mathrm{d}x {\color{C2}\;= \tan x - \sec x + c}$
      \item $\ds\int\!\frac{e^{3x} + 1}{e^x + 1}\,\mathrm{d}x {\color{C2}\;= \frac{e^{2x}}{2} - e^x + x + c}$
    \end{enumerate} 
  \end{multicols}
\end{exe}
\subsection*{變數變換法}
...
\begin{exe} 以變數變換法求下列不定積分. 注意: 可能會因為常數項而跟此處答案不同. 
  ...
  \begin{multicols}{2}
    \begin{enumerate}\setlength{\itemsep}{0pt}
      ...
      \item $\ds\int\!\sin(3x - 1)\,\mathrm{d}x {\color{C2}\;= \frac{-\cos(3x - 1)}{3} + c}$
      ...
      \item $\ds\int\!\sin 3x\cos 3x\,\mathrm{d}x {\color{C2}\;= \frac{\sin^2 3x}{6} + c}$
      \item $\ds\int\!\frac{\cos 3x}{\sin^2 3x}\,\mathrm{d}x {\color{C2}\;= \frac{-1}{3\sin 3x} + c}$
...
\begin{sol}
  \begin{enumerate}\setlength{\itemsep}{0pt}
    ...
    \item 令 $u = 3x - 1$, 則 $\ds\text{d}u = 3\,\text{d}x\ie \text{d}x = \frac{1}{3}\,\text{d}u$. 故 $\ds\int\!\sin(3 x - 1)\,\mathrm{d}x = \int\!\sin{u}\cdot\frac{1}{3}\,\text{d}u = -\frac{1}{3}\,\cos{u} + c = \frac{-\cos(3x - 1)}{3} + c$. 
    ...
    \item 令 $\ds u = \sin 3x$, 則 $\ds\text{d}u = 3\cos 3x\,\text{d}x\ie\cos 3x\,\text{d}x = \frac{1}{3}\,\text{d}u$. 故 $\ds\int\!\sin 3x\cos 3x\,\mathrm{d}x = \int\!u\cdot\frac{1}{3}\,\text{d}u = \frac{1}{3}\cdot\frac{1}{2}\,u^2 + c = \frac{\sin^2 3x}{6} + c$. 
    \item 令 $\ds u = \sin 3x$, 則 $\ds\text{d}u = 3\cos 3x\,\text{d}x\ie\cos 3x\,\text{d}x = \frac{1}{3}\,\text{d}u$. 故 $\ds\int\!\frac{\cos 3x}{\sin^2 3x}\,\mathrm{d}x = \int\!\frac{1}{u^2}\cdot\frac{1}{3}\,\text{d}u = -\frac{1}{3}\cdot\frac{1}{u} + c = -\frac{1}{3\sin 3x} + c$. 
...
\begin{exe} 以變數變換法求下列不定積分, 其中 $a\ne b\ne 0$. 注意: 可能會因為常數項而跟此處答案不同. 
  ...
  \begin{multicols}{2}
    \begin{enumerate}\setlength{\itemsep}{0pt}
      ...
      \item $\ds\int\!\sin^4 x\cos^5 x\,\mathrm{d}x {\color{C2}\;= \frac{\sin^5 x}{5} - \frac{2\sin^7 x}{7} + \frac{\sin^9 x}{9}}$
...
\begin{exe} 以部份積分法求下列不定積分. 注意: 可能會因為常數項而跟此處答案不同. 
  \begin{enumerate}\setlength{\itemsep}{0pt}
    \item $\ds\int\frac{\sin^{-1}x}{x^2}\,\mathrm{d}x {\color{C2}\;= - \frac{\sin^{-1}x}{x} - \ln\Big|\frac{1 - \sqrt{1 - x^2}}{x}\Big| + c}$
    \item $\ds\int\ln(x + \sqrt{1 + x^2})\,\mathrm{d}x {\color{C2}\;= x\,\ln(x + \sqrt{1 + x^2}) - \sqrt{1 + x^2} + c}$
    ...
    \item $\ds\int\!x^2\ln\frac{1 - x}{1 + x}\,\mathrm{d}x {\color{C2}\;= \frac{x^3}{3}\ln\frac{1 - x}{1 + x} - \frac{x^2 + \ln(x^2 - 1)}{3} + c}$
...
\begin{sol}
  \begin{enumerate}\setlength{\itemsep}{0pt}
    \item[]
    \item 令 $\ds u = \sin^{-1}x$, 則 $\ds\text{d}u = \frac{1}{\sqrt{1 - x^2}}\,\text{d}x$; $\ds\text{d}v = \frac{1}{x^2}\,\text{d}x$, 則 $\ds v = \frac{-1}{x}$. 故 $\ds\int\frac{\sin^{-1}x}{x^2}\,\mathrm{d}x = \sin^{-1}x\cdot\frac{-1}{x} - \int\!\frac{-1}{x}\cdot\frac{1}{\sqrt{1 - x^2}}\,\text{d}x = -\frac{\sin^{-1}x}{x} + \int\!\frac{1}{x\sqrt{1 - x^2}}\,\text{d}x$. 令 $\ds w = \sqrt{1 - x^2}$, 則 $-x^2 = w^2 - 1$, $\ds\text{d}w = \frac{-x}{\sqrt{1 - x^2}}\,\text{d}x$. 故 $\ds\int\!\frac{1}{x\sqrt{1 - x^2}}\,\text{d}x = \int\!\frac{1}{-x^2}\cdot\frac{-x}{\sqrt{1 - x^2}}\,\text{d}x = \int\frac{1}{w^2 - 1}\,\text{d}w = \frac{1}{2}\int\Big(\frac{1}{w - 1} - \frac{1}{w + 1}\Big)\,\text{d}w = \frac{1}{2}\big(\ln|w - 1| - \ln|w + 1|\big) = \frac{1}{2}\ln\Big|\frac{w - 1}{w + 1}\Big| = \frac{1}{2}\ln\bigg|\frac{\sqrt{1 - x^2} - 1}{\sqrt{1 - x^2} + 1}\bigg| = \frac{1}{2}\ln\bigg|\frac{1 - \sqrt{1 - x^2}}{1 + \sqrt{1 - x^2}}\bigg| = \frac{1}{2}\ln\bigg|\frac{1 - \sqrt{1 - x^2}}{1 + \sqrt{1 - x^2}}\cdot\frac{1 - \sqrt{1 - x^2}}{1 - \sqrt{1 - x^2}}\bigg| = \frac{1}{2}\ln\bigg|\frac{(1 - \sqrt{1 - x^2})^2}{x^2}\bigg| = \ln\bigg|\frac{1 - \sqrt{1 - x^2}}{x}\bigg|$. \\以上, $\ds\int\frac{\sin^{-1}x}{x^2}\,\mathrm{d}x = - \frac{\sin^{-1}x}{x} + \int\!\frac{1}{x\sqrt{1 - x^2}}\,\text{d}x = - \frac{\sin^{-1}x}{x} + \ln\bigg|\frac{1 - \sqrt{1 - x^2}}{x}\bigg| + c$.
    \item 令 $\ds u = \ln(x + \sqrt{1 + x^2})$, 則 $\ds\text{d}u = \frac{1}{x + \sqrt{1 + x^2}}\cdot\big(x + \sqrt{1 + x^2}\big)'\,\text{d}x = \frac{1}{x + \sqrt{1 + x^2}}\cdot\Big(1 + \frac{x}{\sqrt{1 + x^2}}\Big)\,\text{d}x = \frac{1}{\sqrt{1 + x^2}}\,\text{d}x$; $\ds\text{d}v = \text{d}x$, 則 $\ds v = x$. 故 $\ds\int\ln(x + \sqrt{1 + x^2})\,\mathrm{d}x = \ln(x + \sqrt{1 + x^2})\cdot x - \int\!x\cdot\frac{1}{\sqrt{1 + x^2}}\,\text{d}x = \ln(x + \sqrt{1 + x^2})\,x - \sqrt{1 + x^2} + c$.
...
\item 令 $\ds w = \sqrt{x}$, 則 $\ds w^2 = x$, $\ds\text{d}x = 2w\,\text{d}w$, 故 $\ds\int x e^{\sqrt{x}}\,\mathrm{d}x = \int w^2 e^w\cdot 2w\,\text{d}w = 2\int w^3 e^w\,\text{d}w = 2\,e^w(w^3 - 3w^2 + 6w - 6) = 2\,e^{\sqrt{x}}\,(x\sqrt{x} - 3 x + 6\sqrt{x} - 6) + c$ \\ 
  ...
  \end{minipage}
    ...
    \item 令 $\ds u = \ln\frac{1 - x}{1 + x}$, 則 $\ds\text{d}u = \frac{1 + x}{1 - x}\cdot\Big(\frac{1 - x}{1 + x}\Big)'\,\text{d}x = \frac{1 + x}{1 - x}\cdot\frac{(1 + x)\cdot(-1)-(1 - x)}{(1 + x)^2}\,\text{d}x = \frac{2}{x^2 - 1}\,\text{d}x$; $\ds\text{d}v = x^2\,\text{d}x$, 則 $\ds v = \frac{x^3}{3}$. 故 $\ds\int\!x^2\ln\frac{1 - x}{1 + x}\,\mathrm{d}x = \ln\frac{1 - x}{1 + x}\cdot\frac{x^3}{3} - \int\frac{x^3}{3}\cdot\frac{2}{x^2 - 1}\,\text{d}x$. 又 $\ds\int\frac{x^3}{3}\cdot\frac{2}{x^2 - 1}\,\text{d}x = \frac{2}{3}\int\!\frac{x^3}{x^2 - 1}\,\text{d}x = \frac{2}{3}\int\!\Big(x + \frac{x}{x^2 - 1}\Big)\,\text{d}x = \frac{x^2}{3} + \frac{2}{3}\int\!\frac{x}{x^2 - 1}\,\text{d}x$. 令 $\ds w = x^2 - 1$, 則 $\ds\text{d}w = 2x\,\text{d}x\ie x\,\text{d}x = \frac{1}{2}\,\text{d}w$, 故 $\ds\int\!\frac{x}{x^2 - 1}\,\text{d}x = \int\!\frac{1}{x^2 - 1}\cdot x\,\text{d}x = \int\!\frac{1}{w}\cdot\frac{1}{2}\,\text{d}w = \frac{1}{2}\ln w + c = \frac{1}{2}\ln(x^2 - 1) + c$. 以上, $\ds\int x^2\ln\frac{1 - x}{1 + x}\,\mathrm{d}x = \frac{1 + x}{1 - x}\cdot\frac{x^3}{3} - \int\!\frac{x^3}{3}\cdot\frac{1}{x^2 - 1}\,\text{d}x = \ln\frac{1 - x}{1 + x}\cdot\frac{x^3}{3} - \frac{x^2 + \ln(x^2 - 1)}{3} + c$. 
...
\begin{sol}
  \begin{enumerate}\setlength{\itemsep}{0pt}
    ...
    \item 令 $\ds x = a\tan\theta$, 則 $\ds\int\!\sqrt{x^2 + a^2}\,\text{d}x = \int\!a\sec\theta\cdot a\sec^2\theta\,\text{d}\theta = a^2\!\int\!\sec^3\theta\,\text{d}\theta$. 令 $\ds u = \sec\theta$, 則 $\ds\mathrm{d}u = \sec\theta\tan\theta\,\mathrm{d}\theta$; 令 $\ds\mathrm{d}v = \sec^2\theta\,\mathrm{d}\theta$, 則 $\ds v = \tan\theta$. 故 $\ds\int\!\sec^3\theta\,\text{d}\theta = \sec\theta\cdot\tan\theta - \int\!\tan\theta\cdot\sec\theta\tan\theta\,\mathrm{d}\theta = \sec\theta\cdot\tan\theta - \int\!\sec\theta\cdot\tan^2\theta\,\mathrm{d}\theta = \sec\theta\cdot\tan\theta - \int\!\sec\theta\cdot(\sec^2\theta - 1)\,\mathrm{d}\theta = \sec\theta\cdot\tan\theta - \int\!\sec^3\theta\,\mathrm{d}\theta + \int\!\sec\theta\,\mathrm{d}\theta \ie \int\!\sec^3\theta\,\text{d}\theta = \frac{\sec\theta\cdot\tan\theta + \int\!\sec\theta\,\text{d}\theta}{2} = \frac{\sec\theta\cdot\tan\theta + \ln|\sec\theta + \tan\theta|}{2}$; $\ds\int\!\sqrt{x^2 + a^2}\,\text{d}x = a^2\!\int\!\sec^3\theta\,\text{d}\theta = a^2\frac{\frac{\sqrt{x^2 + a^2}}{a}\cdot\frac{x}{a} + \ln\big|\frac{\sqrt{x^2 + a^2}}{a} + \frac{x}{a}\big|}{2} = \frac{x\sqrt{x^2 + a^2} + a^2\ln\big|\sqrt{x^2 + a^2} + x\big| - a^2\ln|a|}{2}$
...
\begin{ex} 
  ...
  \begin{multicols}{3}
    \begin{enumerate}\setlength{\itemsep}{0pt}
      \item $\ds\int_{-\infty}^{\infty}\!\frac{1}{1 + x^2}\,\mathrm{d}x$. 
      \item $\ds\int_{1}^{\infty}\!\frac{1}{x^2}\,\mathrm{d}x$.
      \item $\ds\int_0^1\!\frac{1}{\sqrt{x}}\,\mathrm{d}x$. 
    \end{enumerate}
  \end{multicols}
\end{ex}
...
\begin{sol}\leavevmode
  \begin{enumerate}\setlength{\itemsep}{0pt}
    \item $\ds\int_{-\infty}^{\infty}\!\frac{1}{1 + x^2}\,\mathrm{d}x = 2\int_0^\infty\!\frac{1}{1 + x^2}\,\mathrm{d}x = 2\lim_{b\to\infty}\int_0^b\!\frac{1}{1 + x^2}\,\mathrm{d}x = 2\lim_{b\to\infty}\tan^{-1} b = 2\cdot\frac{\pi}{2} = \pi$. 
    \item $\ds\int_{1}^{\infty}\!\frac{1}{x^2}\,\mathrm{d}x = \lim_{b\to\infty}\int_1^b\!\frac{1}{x^2}\,\mathrm{d}x = \lim_{b\to\infty}\big(-\frac{1}{b} + 1\big) = 1$
    \item $\ds\int_0^1\!\frac{1}{\sqrt{x}}\,\mathrm{d}x = \lim_{c\to0+}\int_c^1\!\frac{1}{\sqrt{x}}\,\mathrm{d}x = \lim_{c\to0+}2\sqrt{x}\,\Big|^1_c = \lim_{c\to0+}(2-2\sqrt{c}) = 2$
  \end{enumerate}
\end{sol}
