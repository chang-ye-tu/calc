...
\begin{ex}
  $\ds\int \sqrt{x}\,\text{d}x = \frac{2}{3}\,x^{\frac{3}{2}} + c$，$\ds\int x^\pi\,\text{d}x = \frac{1}{\pi + 1}\,x^{\pi + 1} + c$，$\ds\int\sin\pi x\,\text{d}x = -\frac{1}{\pi}\cos\pi x + c$，$\ds\int\cos xy\,\text{d}x = \frac{1}{y}\sin xy + c$，$\ds\int e^{-2x}\,\text{d}x = -\frac{1}{2}\,e^{-2 x} + c$，$\ds\int\frac{1}{\sqrt{\pi - x^2}}\,\text{d}x = \sin^{-1}\frac{x}{\sqrt{\pi}} + c$，$\ds\int\frac{1}{e + u^2}\,\text{d}u = \frac{1}{\sqrt{e}}\,\tan^{-1}\frac{u}{\sqrt{e}} + c$
\end{ex}
