...
\begin{ex}
  \begin{enumerate}\setlength{\itemsep}{0pt}
    \item[]
    \item $\ds\int_{-\sqrt{2}}^{\sqrt{2}} \sqrt{2 - x^2}\,\text{d}x = \pi$ (半徑 $\sqrt{2}$ 之半圓面積) 
    \item $\ds\int_{-1}^2 \sgn(x)\,\text{d}x = 2\cdot 1 - 1\cdot 1 = 1$; $\ds\sgn(x)\equiv\begin{cases} 1 & x > 0 \\ -1 & x < 0\end{cases}$ 
    \item $\ds\int_{-\pi}^{\pi} \sin(x^7-5x^3)\,\text{d}x = 0$ ($\sin(x^7-5x^3)$ 為奇函數) 
    \item $\ds\int_{-6}^{6} e^{-x^4}\sin(\sin x)\,\text{d}x = 0$ ($e^{-x^4}\sin(\sin x)$ 為奇函數) 
    \item $\ds\int_{-4}^{4} \big(e^{x} - e^{-x}\big)\,\text{d}x = 0$ ($e^{x} - e^{-x}$ 為奇函數) 
    \item $\ds\int_{-2024}^{2024} \big(e^{9x^5-2x^7} - e^{-9x^5 + 2x^7}\big)\,\text{d}x = 0$ ($e^{9x^5-2x^7} - e^{-9x^5 + 2x^7}$ 為奇函數)  
    \item $\ds\int_{-a}^a |x|\,\text{d}x = 2\int_0^a |x|\,\text{d}x = a^2$ ($|x|$ 為偶函數; 兩 $a\times a$ 等腰直角三角形面積) 
    \item 定義 $\ds\int_1^x\frac{1}{\tau}\,\text{d}\tau\equiv\ln x$, 則 $\ds\int_{\frac{1}{4}}^3\frac{1}{x}\,\text{d}x = \int_{\frac{1}{4}}^1 \frac{1}{x}\,\text{d}x + \int_1^3 \frac{1}{x}\,\text{d}x = -\int_1^{\frac{1}{4}}\frac{1}{x}\,\text{d}x + \int_1^3\frac{1}{x}\,\text{d}x = \ln 12$
