...
\begin{exe} 以變數變換法求下列不定積分。注意：可能會因為常數項而跟此處答案不同。
  ...
  \begin{multicols}{2}
    \begin{enumerate}\setlength\itemsep{0em}
      ...
      \item $\ds\int\frac{\sin^3(\ln x)\cos^3(\ln x)}{x}\,\mathrm{d}x {\color{C2}\,\,= \frac{\sin^4(\ln x)}{4} - \frac{\sin^6(\ln x)}{6}}$
      ...
      \item $\ds\int\sin ax\cos bx\,\mathrm{d}x {\color{C2}\,\,= -\frac{\cos{(a-b)x}}{2(a-b)} - \frac{\cos{(a+b)x}}{2(a+b)}}$
    \end{enumerate} 
  \end{multicols}
\end{exe}
...
\begin{sol}
  \begin{enumerate}\setlength\itemsep{0em}
    ...
    \item $\ds\int\frac{1}{e^x + e^{-x}}\,\mathrm{d}x = \int\frac{e^x}{e^{2x} + 1}\,\text{d}x$。令 $\ds u = e^x$，故 $\ds\text{d}u = e^x\,\text{d}x$，則 $\ds\int\frac{e^x}{e^{2x} + 1}\,\text{d}x = \int\frac{1}{e^{2x} + 1}\cdot e^x\,\text{d}x = \int\frac{1}{u^2 + 1}\,\text{d}u = \tan^{-1}u + c = \tan^{-1}{e^{x}} + c$。
